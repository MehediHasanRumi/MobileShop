        ...
        protected void btnResetPass_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["MyShoppingDB"].ConnectionString))
            {
                ...
                if (dt.Rows.Count != 0)
                {
                    ...
                    String EmailBody = "Hi ," + Username + ",<br/><br/>Click the link below to reset your password<br/> <br/> https://localhost:44352/RecoverPassword.aspx?id=" + myGUID;

                    MailMessage PassRecMail = new MailMessage("emon414419@gmail.com", ToEmailAddress);
                    ...
                    using (SmtpClient client = new SmtpClient())
                    {
                        ...
                        client.Credentials = new NetworkCredential("emon414419@gmail.com", "abcd@414419");
