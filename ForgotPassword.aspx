<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ForgotPassword.aspx.cs" Inherits="MobileShop.ForgotPassword" %>
        ...
        <div class="container">
            <div class ="form-horizontal">
                ...
                <div class ="form-group">
                    ...
                    <div class ="col-md-6">
                        <asp:Button ID="btnResetPass" CssClass ="btn btn-default" runat="server" Text="Send" OnClick="btnResetPass_Click" BackColor="Green" />
